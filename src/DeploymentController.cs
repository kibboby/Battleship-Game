...
static class DeploymentController
{
	...
	public static void HandleDeploymentInput()
	{
		...
		if (SwinGame.KeyTyped(SwinGameSDK.KeyCode.vk_UP) | SwinGame.KeyTyped(SwinGameSDK.KeyCode.vk_DOWN)) {
			_currentDirection = Direction.UpDown;
		}
		if (SwinGame.KeyTyped(SwinGameSDK.KeyCode.vk_LEFT) | SwinGame.KeyTyped(SwinGameSDK.KeyCode.vk_RIGHT)) {
			_currentDirection = Direction.LeftRight;
		}

		if (SwinGame.KeyTyped(SwinGameSDK.KeyCode.vk_r)) {
