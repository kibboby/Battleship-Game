	...
	public static void DrawBackground()
	{
		switch (GameController.CurrentState) {
			...
			case GameState.AlteringOption:
				SwinGame.DrawBitmap (GameResources.GameImage ("a1"), 0, 0);
				break;
			case GameState.ViewingHighScores:
				SwinGame.DrawBitmap(GameResources.GameImage("a2"), 0, 0);
				break;
			...
			case GameState.ViewHowToPlay:
				SwinGame.DrawBitmap (GameResources.GameImage ("a3"), 0, 0);
				break;
			default:
